...
def build_evaluation_dataset(min_interactions=5):
    ...
    for uid in user_ids:
        ...
        inters = (
            UserViewInteraction.objects.filter(user_id=uid, show__embedding__isnull=False)
            .select_related("show")
        ...
        for i in train_inters:
            train_data_for_calc.append({"rating": i.rating, "show": {"embedding": i.show.embedding}})
