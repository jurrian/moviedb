...
def export_run(run_id: str, output_dir: Path, experiment_name: str | None = None):
...
def main():
    parser = argparse.ArgumentParser(description="Export MLflow experiments/runs to baseline directory for sharing")

    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument("--experiment", help="Name of the experiment to export")
    group.add_argument("--run-id", help="ID of the specific run to export")
